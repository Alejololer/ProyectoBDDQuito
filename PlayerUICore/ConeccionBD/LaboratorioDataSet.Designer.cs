...
namespace PlayerUICore.ConeccionBD {
    ...
    public partial class LaboratorioDataSet : global::System.Data.DataSet {
        ...
        public partial class UsuariosDataTable : global::System.Data.TypedTableBase<UsuariosRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public UsuariosRow AddUsuariosRow(string userName, string password, string firstName, string lastName, string position, string email) {
...
namespace PlayerUICore.ConeccionBD.LaboratorioDataSetTableAdapters {
    ...
    public partial class UsuariosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Usuarios] WHERE (([id] = @Original_id) AND ([userName] = @Original_userName) AND ([password] = @Original_password) AND ([firstName] = @Original_firstName) AND ([lastName] = @Original_lastName) AND ([position] = @Original_position) AND ([email] = @Original_email))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Usuarios] ([userName], [password], [firstName], [lastName], [position], [email]) VALUES (@userName, @password, @firstName, @lastName, @position, @email);
SELECT id, userName, password, firstName, lastName, position, email FROM Usuarios WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Usuarios] SET [userName] = @userName, [password] = @password, [firstName] = @firstName, [lastName] = @lastName, [position] = @position, [email] = @email WHERE (([id] = @Original_id) AND ([userName] = @Original_userName) AND ([password] = @Original_password) AND ([firstName] = @Original_firstName) AND ([lastName] = @Original_lastName) AND ([position] = @Original_position) AND ([email] = @Original_email));
SELECT id, userName, password, firstName, lastName, position, email FROM Usuarios WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::PlayerUICore.Properties.Settings.Default.LaboratorioConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, userName, password, firstName, lastName, position, email FROM dbo.Usua" +
                "rios";
        ...
        public virtual int Fill(LaboratorioDataSet.UsuariosDataTable dataTable) {
        ...
        public virtual LaboratorioDataSet.UsuariosDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            LaboratorioDataSet.UsuariosDataTable dataTable = new LaboratorioDataSet.UsuariosDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(LaboratorioDataSet.UsuariosDataTable dataTable) {
        ...
        public virtual int Delete(int Original_id, string Original_userName, string Original_password, string Original_firstName, string Original_lastName, string Original_position, string Original_email) {
        ...
        public virtual int Insert(string userName, string password, string firstName, string lastName, string position, string email) {
            if ((userName == null)) {
        ...
        public virtual int Update(string userName, string password, string firstName, string lastName, string position, string email, int Original_id, string Original_userName, string Original_password, string Original_firstName, string Original_lastName, string Original_position, string Original_email, int id) {
            if ((userName == null)) {
                throw new global::System.ArgumentNullException("userName");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string userName, string password, string firstName, string lastName, string position, string email, int Original_id, string Original_userName, string Original_password, string Original_firstName, string Original_lastName, string Original_position, string Original_email) {
            return this.Update(userName, password, firstName, lastName, position, email, Original_id, Original_userName, Original_password, Original_firstName, Original_lastName, Original_position, Original_email, Original_id);
        }
    }
